...
import bitcard.cosc431.bitcard.Constants;

/**
 * Created by Lynx on 4/11/2017.
 */
public class MainUserPresenter implements MainUserContract.MainActivityPresenter {

    private MainUserContract.MainActivityView view;
    private File walletDir; //Context.getCacheDir();

    private NetworkParameters parameters;
    private WalletAppKit walletAppKit;

    public MainUserPresenter(MainUserContract.MainActivityView view, File walletDir) {
        this.view = view;
