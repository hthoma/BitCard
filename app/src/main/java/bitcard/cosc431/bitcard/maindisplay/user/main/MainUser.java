...
@EActivity(R.layout.activity_user_view)
@OptionsMenu(R.menu.menu_main)
public class MainUser extends AppCompatActivity implements MainUserContract.MainActivityView {

    private MainUserContract.MainActivityPresenter presenter;
    ...
    protected void initData() {
        new MainUserPresenter(this, getCacheDir());
    }
    ...
    @Override
    public void setPresenter(MainUserContract.MainActivityPresenter presenter) {
    ...
    private void setListeners() {
        ...
        ivCopy_AM.setOnClickListener(v -> {
            ...
            Toast.makeText(MainUser.this, "Copied", Toast.LENGTH_SHORT).show();
        });
    }
}
